...
function ProductHero({ title, description }: { title: string; description?: string }) {
  return (
    <div
      className="flex flex-col justify-between min-h-[50vh] desktop:px-20 mobile:p-6"
      style={{
        backgroundImage: 'url("/image/hero/products.png")', // Replace with your product hero image
